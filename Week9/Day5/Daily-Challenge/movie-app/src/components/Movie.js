            ...
            <div id='movie-search'>
                <section id='movie-container'>
                    ...
                    <>
                        <div id='movie-poster-div'>
                            <img id='movie-poster-img' src={this.props.movie.Poster} />
                        </div>
                        <div id='movie-details'>
                            ...
                            <br />
                            <b>IMDB Rating: </b>{this.props.movie.imdbRating}
                            <br />
                            <b>Director: </b>{this.props.movie.Director}
                            <br />
                            <b>Writer: </b>{this.props.movie.Writer}
                            <br />
                ...
                <div id='about-section'>
                    ...
                    <p>{this.props.movie.Plot}</p>
                        ...
                        <button id='more-details-button' onClick={()=>{window.location.href = `https://imdb.com/title/${this.props.movie.imdbID}/`}}>
                            View on IMDB
                        </button>
                    <Link to={`/`}>
